etcd --name="elwood1" \
  ...
  --listen-peer-urls="http://192.168.99.8:2380" \
  --listen-client-urls="http://192.168.99.8:2379,http://127.0.0.1:2379" \
  --initial-advertise-peer-urls="http://192.168.99.8:2380" \
